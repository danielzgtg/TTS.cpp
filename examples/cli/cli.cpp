...
int main(int argc, const char ** argv) {
    ...
    args.add_argument(string_arg("--save-path", "(OPTIONAL) The path to save the audio output to in a .wav format. Defaults to TTS.cpp.wav", "-sp", false));
    ...
    if (!play_tts_response(args, data)) {
